;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="8d45c18589f49212e9eddf00c9c13d63";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["69bzK0JJbzUG"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["69bzK0JJbzUG"].options={"anonymizeIp":true,"id":"UA-35224026-1","social":true};;CloudflareApps.installs["wddQXQi2HhWh"]={appId:"FwMlx_iKQIWc",scope:{}};;CloudflareApps.installs["wddQXQi2HhWh"].options={"container_id":""};;if(CloudflareApps.matchPage(CloudflareApps.installs['69bzK0JJbzUG'].URLPatterns)){(function(){var options=CloudflareApps.installs['69bzK0JJbzUG'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("69bzK0JJbzUG"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
...
gtag("event","share",{method:"twitter",event_action:"tweet",content_id:targetUrl});}});}},false);}})();}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/8Rt0R1Zp_7Kc0bvvDPw88uJfKw8.js';document.head.appendChild(script);})();